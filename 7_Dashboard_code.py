...
app.layout = html.Div(children=[
    ...
    dcc.RangeSlider(id='payload-slider',
                    ...
                    marks={0: '0', 10000: '10000'},  # Changed 100 to 10000 for the mark
...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df, names='class', title='Total Success Launches by Site at {}'.format(entered_site))
    return fig
...
def get_scatterplot(entered_site, payload_range):
    if entered_site == 'ALL':
        ...
        filtered_df = spacex_df[(spacex_df['Launch Site'] == entered_site) &
                                ...
                                (spacex_df['Payload Mass (kg)'] <= payload_range[1])]
        title = 'Correlation between Payload and Success at {}'.format(entered_site)
